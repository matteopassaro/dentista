...
export const metadata = pageMetadata({
  title: "Blog",
  description: `Articoli su prevenzione, terapie e salute orale da ${siteConfig.name}.`,
  path: "/blog",
});
    ...
    <Section>
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mt-3 text-[var(--muted)]">
          Approfondimenti scritti dal team clinico per informare, non sostituire la visita.
        </p>
      </div>
